...
export const MainUI: React.FC = () => {
  ...
  return (
    <Container style={styles.pageLayout} fluid>
      <div style={styles.navbarLayout}>
        ...
        >
          <Button style={styles.linkStyle} onClick={() => setTool(<Home />)}>
            Home
          </Button>

          <Button style={styles.linkStyle} onClick={() => setTool(<Courses />)}>
            Courses
          </Button>
        ...
        <div style={styles.iconStyle}>Bell</div>
      </div>
